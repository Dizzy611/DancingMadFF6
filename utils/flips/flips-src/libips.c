...
#define read24() (patchat+=3,((patchat[-3]<<16)|(patchat[-2]<<8)|patchat[-1]))
	...
	//unsigned int wastebytes=0;
	//unsigned int wastebytesnonrle=0;
	//unsigned int totalbytes=0;
	//unsigned int wasteblocks=0;
	...
	while (offset!=0x454F46)
	{
		...
		if (size==0)
		{
			...
			//unsigned int wastestart;
			//signed int wasteend;//otherwise it blows up
			//for (wastestart=0;wastestart<size && (out->ptr+offset)[wastestart]==b && offset+wastestart<in.len;wastestart++) {}
			//for (wasteend=size-1;wasteend>=0 && (out->ptr+offset)[wasteend]==b && offset+wasteend<in.len;wasteend--) {}
			//if (wastestart==size)
			//{
			//printf("RLE:*/%u\t@%.6X\n",size,offset);
			//	wastebytes+=size;
			...
			//else
			//{
			//if(wastestart||(size-1-wasteend))
			//{
			//printf("RLE:%u+%u/%u\t@%.6X\n",wastestart,(size-1-wasteend),size,offset);
			//}
			//	wastebytes+=wastestart;
			//	wastebytes+=(size-1-wasteend);
			//}
			//
			//totalblocks++;
			//totalbytes+=size;
		...
		else
		{
			//unsigned int wastestart;
			//signed int wasteend;
			//for (wastestart=0;wastestart<size && (out->ptr+offset)[wastestart]==patchat[wastestart] && offset+wastestart<in.len;wastestart++) {}
			//for (wasteend=size-1;wasteend>=0 && (out->ptr+offset)[wasteend]==patchat[wasteend] && offset+wasteend<in.len;wasteend--) {}
			//if (wastestart==size)
			//{
			//printf("CPY:*/%u\t@%.6X\n",size,offset);
			//	wastebytes+=size;
			//	wastebytesnonrle+=size;
			//	wasteblocks++;
			//}
			//else
			//{
			...
			//}
			//	wastebytes+=wastestart;
			//	wastebytesnonrle+=wastestart;
			//	wastebytes+=(size-1-wasteend);
			//	wastebytesnonrle+=(size-1-wasteend);
			//}
			//
			//totalblocks++;
			//totalbytes+=size;
...
#undef read24
	...
	//printf("libips: %u of %u bytes wastefully changed (of which %u matter), ", wastebytes, totalbytes, wastebytesnonrle);
	//printf("%u/%u fully useless blocks\n", wasteblocks, totalblocks);
...
#undef write
	patchmem->ptr=out;
	patchmem->len=outlen;
	if (sixteenmegabytes) return ips_16MB;
